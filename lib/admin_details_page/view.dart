...
class AdminDetailsPage extends StatefulWidget {
  ...
  const AdminDetailsPage({Key key, this.planName}) : super(key: key);
  @override
...
class _AdminDetailsPageState extends State<AdminDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AdminDetailsPageBloc, AdminDetailsPageState>(
      cubit: ab,
      builder: (context, state) {
        ...
        if (state is UILoaded) {
          ...
          ab.add(LoadUIEvent(context, widget.planName));
          return loadingWidget();
        }
      },
                      ...
                      child: Align(
                          ...
                          child: Dismissible(
                              ...
                              onDismissed: (direction) {
                                ab.add(
                                    CloseRequestEvent(index, widget.planName));
                              },
