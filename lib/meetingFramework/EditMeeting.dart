...
class _EditMeetingState extends State<EditMeeting> {
  ...
  @override
  void initState() {
    // TODO: This is how we access the data passed in constructor to stateful widget class !!!
    DateTime startTime =
    ...
    currentLocation = widget.event.className;
                ...
                : () async {
                    ...
                    await calendarClient
                      ...
                      await storage
                          .deleteEvent(
                              id: eventId,
                              planName: widget.event.className,
                              attendeesList: attendeeEmails)
