                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: new InputDecoration(
                        ...
                        errorText: isEditingEndDate &&
                                textControllerEndDate.text != null
                    ...
                    TextField(
                      ...
                      onSubmitted: (value) {
                        ...
                        FocusScope.of(context)
                            .requestFocus(textFocusNodeClassName);
                      },
                      style: TextStyle(
                        color: Colors.black87,
                        fontWeight: FontWeight.bold,
                    ...
                    TextField(
                      ...
                      cursorColor: CustomColor.sea_blue,
                      focusNode: textFocusNodeClassName,
                      controller: textControllerClassName,
                      ...
                      onSubmitted: (value) {
                        textFocusNodeClassName.unfocus();
                        FocusScope.of(context)
  ...
  _selectEndDate(BuildContext context) async {
    ...
    if (picked != null && picked != selectedEndDate) {
      setState(() {
        ...
        textControllerEndDate.text =
            DateFormat.yMMMMd().format(selectedEndDate);
      });
    }
  }
